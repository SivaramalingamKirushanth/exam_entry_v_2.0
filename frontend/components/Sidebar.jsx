...
const Sidebar = () => {
  return (
    <div className="w-12 hover:w-48 transition-all duration-300 overflow-hidden rounded-tr-xl rounded-br-xl fixed top-[50%] -translate-y-1/2 left-0 shadow-xl bg-white py-3 flex flex-col items-start">
      <Link
        href="/home"
