      ...
      <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
        <div className="flex flex-col sm:items-center mb-4">
          <p className="font-bold text-lg text-gray-800">
            Dr. S. Kirushanth <span className="text-sm font-normal text-gray-600">(System Design and DevOps)</span>
          </p>
        ...
        <div className="flex flex-col sm:items-center">
          <p className="font-bold text-lg text-gray-800">
            Mr. T. Jeyamugan <span className="text-sm font-normal text-gray-600">(Requirements Specification and Database Design)</span>
          </p>
          <p className="text-sm text-gray-600 sm:text-center">
            Department of Physical Science
          </p>
    ...
    <section>
      ...
      <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:border-purple-200 transition-all">
        <div className="flex flex-col sm:items-center">
          <p className="font-bold text-md text-gray-800">
            Mr. Zahran Liyasdeen <span className="text-sm font-normal text-gray-600">(Lead Developer)</span>
          </p>
      ...
      <div className="text-xs text-gray-500 mt-6 bg-gray-50 p-4 rounded-md border border-gray-100 text-center">
        <p className="mb-1 font-medium text-gray-600">
          <em>Other Members who worked on Exam Entry System v1.0 (initial group project):</em>
        </p>
