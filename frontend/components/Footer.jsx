      ...
      <footer className="bg-[hsl(240,5.9%,10%)] text-white py-3 mt-6 text-center">
        <div className="container mx-auto px-4 flex flex-col items-center">
          ...
          <button
            ...
            className="relative inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/40 disabled:pointer-events-none disabled:opacity-50 h-9 px-4 py-2 mt-3 text-white shadow-lg overflow-hidden border border-transparent mb-3 sm:mb-1"
          >
            ...
            <div className="flex-1 overflow-y-auto px-6 sm:px-8 py-3">
              ...
              <section className="mb-8">
                <div className="flex items-center justify-center mb-4">
                  ...
                  <p className="text-sm font-semibold text-gray-500 uppercase tracking-wider whitespace-nowrap">
                    System Design and Development Team
                  </p>
                ...
                <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
                  <div className="flex flex-col items-center mb-4">
                    <p className="font-bold text-lg text-gray-800 flex gap-x-1 flex-wrap items-center justify-center">
                      <span className="text-center">Dr. S. Kirushanth</span>
                      <span className="text-sm font-normal text-gray-600 text-center">
                  ...
                  <div className="flex flex-col items-center">
                    <p className="font-bold text-lg text-gray-800 flex gap-x-1 flex-wrap items-center justify-center">
                      <span className="text-center">Mr. T. Jeyamugan</span>
                      <span className="text-sm font-normal text-gray-600 text-center">
                        (Requirements Specification and Database Design)
                      </span>
                    </p>
                    <p className="text-sm text-gray-600 text-center">
                      Department of Physical Science
              ...
              <section>
                ...
                <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:border-purple-200 transition-all">
                  <div className="flex flex-col items-center">
                    <p className="font-bold text-md text-gray-800 flex gap-x-1 flex-wrap items-center justify-center">
                      <span className="text-center">Mr. Zahran Liyasdeen</span>
                      <span className="text-sm font-normal text-gray-600 text-center">
                        (Lead Developer)
                      </span>
                    </p>
