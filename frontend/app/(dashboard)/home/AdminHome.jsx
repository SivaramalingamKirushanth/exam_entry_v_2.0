...
const AdminHome = () => {
  ...
  return (
    <div className="flex justify-end md:justify-center">
      <div className="w-[80%] md:w-[85%] lg:w-[70%] flex flex-col sm:flex-row gap-6 flex-wrap justify-center">
        {adminSummaryData && (
          ...
          allActiveBatchesProgessesData.length && (
            <div className="container mx-auto mb-3">
              ...
              <Table>
                ...
                <TableBody>
                  {allActiveBatchesProgessesData &&
                    allActiveBatchesProgessesData.filter(
                      (obj, i) => obj.btp_data
                    ).length &&
                    (allActiveBatchesProgessesData.filter(
                      (obj, i) => obj.btp_data
